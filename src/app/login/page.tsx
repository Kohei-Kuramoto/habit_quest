    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-900 flex items-center justify-center">
      <div className="bg-white/10 backdrop-blur-md rounded-2xl p-10 flex flex-col items-center gap-6 shadow-2xl border border-white/20 w-full max-w-sm">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-2">HabitQuest</h1>
          <p className="text-purple-200 text-sm">習慣をRPGで楽しもう</p>
        </div>
        ...
        >
          <button
            type="submit"
            className="w-full bg-white text-gray-800 font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors shadow-lg"
          >
